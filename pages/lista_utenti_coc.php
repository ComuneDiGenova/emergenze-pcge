...
?>
        ...
        <!-- FINE Modal aggiungi utente coc-->
          ...
          <thead>
                ...
                <!-- <th data-field="funzione_id" data-sortable="false"  data-visible="true">Funzione ID</th> -->
                ...
                ?>
                <th data-field="matricola_cf" data-sortable="false" data-formatter="nameFormatter_mod" data-visible="true" > Edit </th>
                <th data-field="matricola_cf" data-sortable="false" data-formatter="nameFormatter_del" data-visible="true" > Rimuovi </th>
                <?php
                }
                ?>
              </tr>
...
<script>
function nameFormatter_mod(value, row) {
  ...
  return' <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#updateCoc'+row.id+'" title="Modifica dati Componente"><i class="fas fa-user-edit"></i></button>\
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">\
          ...
          <label>Matricola/CF <span style="color:red;">*</span></label><br><br>\
            ...
            <div class="form-group">\
            <select class="form-control"  name="addFunzione" required>\
              <option name="addFunzione" value="'+row.funzione_id+'" selected>'+row.funzione+'</option>\
              <?php 
                for ($i=0;$i<$len;$i++){
                    echo '<option name="addFunzione" value="'.$tipo_funzione[$i][0].'">'.$tipo_funzione[$i][1].'</option>';
                }
...
function nameFormatter_del(value,row) {
    return'<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#elimina'+value+'">\
            ...
            <div class="modal-dialog"> \
              <div class="modal-content">\
                ...
                Vuoi eliminare il componente del COC? clicca qua \
                  <a href="./elimina_componente_coc.php?id='+ value + '" class="btn btn-danger" role="button" title="Elimina componente" >\
                    <i class="fa fa-times" aria-hidden="true"></i> Elimina </a>\
                </div>\
                <!--div class="modal-footer">\
