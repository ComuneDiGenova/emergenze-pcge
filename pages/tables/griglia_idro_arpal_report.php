...
//    UNION
   ...
   s.liv_rosso as rosso,
         ...
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= (timezone('utc'::text, now()) - '08:00:00'::interval) AND lettura_idrometri_arpa.data_ora < (timezone('utc'::text, now()) - '07:30:00'::interval)) AS \"16\",
   ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= (timezone('utc'::text, now()) - '07:30:00'::interval) AND lettura_idrometri_arpa.data_ora < (timezone('utc'::text, now()) - '07:00:00'::interval)) AS \"15\",
   ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= (timezone('utc'::text, now()) - '07:00:00'::interval) AND lettura_idrometri_arpa.data_ora < (timezone('utc'::text, now()) - '06:30:00'::interval)) AS \"14\",
   ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= (timezone('utc'::text, now()) - '06:30:00'::interval) AND lettura_idrometri_arpa.data_ora < (timezone('utc'::text, now()) - '06:00:00'::interval)) AS \"13\",
       ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= (timezone('utc'::text, now()) - '06:00:00'::interval) AND lettura_idrometri_arpa.data_ora < (timezone('utc'::text, now()) - '05:30:00'::interval)) AS \"12\",
   ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= (timezone('utc'::text, now()) - '05:30:00'::interval) AND lettura_idrometri_arpa.data_ora < (timezone('utc'::text, now()) - '05:00:00'::interval)) AS \"11\",
   ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= (timezone('utc'::text, now()) - '05:00:00'::interval) AND lettura_idrometri_arpa.data_ora < (timezone('utc'::text, now()) - '04:30:00'::interval)) AS \"10\",
   ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= (timezone('utc'::text, now()) - '04:30:00'::interval) AND lettura_idrometri_arpa.data_ora < (timezone('utc'::text, now()) - '04:00:00'::interval)) AS \"9\",
   ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= (timezone('utc'::text, now()) - '04:00:00'::interval) AND lettura_idrometri_arpa.data_ora < (timezone('utc'::text, now()) - '03:30:00'::interval)) AS \"8\",
   ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= (timezone('utc'::text, now()) - '03:30:00'::interval) AND lettura_idrometri_arpa.data_ora < (timezone('utc'::text, now()) - '03:00:00'::interval)) AS \"7\",
   ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= (timezone('utc'::text, now()) - '03:00:00'::interval) AND lettura_idrometri_arpa.data_ora < (timezone('utc'::text, now()) - '02:30:00'::interval)) AS \"6\",
   ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= (timezone('utc'::text, now()) - '02:30:00'::interval) AND lettura_idrometri_arpa.data_ora < (timezone('utc'::text, now()) - '02:00:00'::interval)) AS \"5\",
   ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= (timezone('utc'::text, now()) - '02:00:00'::interval) AND lettura_idrometri_arpa.data_ora < (timezone('utc'::text, now()) - '01:30:00'::interval)) AS \"4\",
   ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= (timezone('utc'::text, now()) - '01:30:00'::interval) AND lettura_idrometri_arpa.data_ora < (timezone('utc'::text, now()) - '01:00:00'::interval)) AS \"3\",
   ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= (timezone('utc'::text, now()) - '01:00:00'::interval) AND lettura_idrometri_arpa.data_ora < (timezone('utc'::text, now()) - '00:30:00'::interval)) AS \"2\",
   ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= (timezone('utc'::text, now()) - '00:30:00'::interval) AND lettura_idrometri_arpa.data_ora < timezone('utc'::text, now())) AS \"1\",
   ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
      ...
      ( SELECT greatest(max(lettura_idrometri_arpa.lettura),0) AS max
          FROM geodb.lettura_idrometri_arpa
         WHERE p.shortcode::text = lettura_idrometri_arpa.id_station::text AND lettura_idrometri_arpa.data_ora >= timezone('utc'::text, now())) AS \"00\"
