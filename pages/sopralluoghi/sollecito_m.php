...
$mail->Subject = 'Urgente - Sollecito per Presidio mobile ricevuto dalla Protezione Civile del Comune di Genova';
//$mail->Subject = 'PHPMailer SMTP without auth test';
//Read an HTML message body from an external file, convert referenced images to embedded,
//convert HTML into a basic plain-text alternative body
$body =  'Hai ricevuto questo messaggio come sollecito perch� la tua Squadra
 '.$uo_descrizione.' Non ha ancora risposto all\'assegnazione del presidio mobile.
 ...
 <a href="http://192.168.153.110/emergenze/pages/dettagli_sopralluogo_mobile.php?id='.$id.'">pagina </a>
...
if (!$mail->send()) {
	...
	//sleep(30);
   header("url=../dettagli_sopralluogo_mobile.php?id=".$id);
} else {
    echo "Message sent!";
