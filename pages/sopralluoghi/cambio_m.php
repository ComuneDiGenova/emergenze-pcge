...
$query="UPDATE segnalazioni.t_sopralluoghi_mobili_richiesta_cambi SET eseguito=null WHERE id_sopralluogo=".$id_sopralluogo." and eseguito = 'f'; ";
echo $query."<br>";
//exit;
$result=pg_query($conn, $query);


$query="UPDATE segnalazioni.join_sopralluoghi_mobili_squadra SET valido=null, data_ora_cambio=now() WHERE id_sopralluogo=".$id_sopralluogo." and valido='t' and id_squadra=".$id_squadra_old."; ";
echo $query."<br>";
//exit;
$result=pg_query($conn, $query);
...
echo $query."<br>";
	...
	$query="INSERT INTO segnalazioni.join_sopralluoghi_mobili_squadra (id_sopralluogo, id_squadra) VALUES (".$id_sopralluogo.",".$id_squadra."); ";
	$result=pg_query($conn, $query);
	echo $query."<br>";
//}
...
$query= "INSERT INTO segnalazioni.t_comunicazioni_sopralluoghi_mobili(id_sopralluogo, testo";
...
if($_POST["permanente"]=='on') {
	...
	$query="UPDATE segnalazioni.t_sopralluoghi_mobili_richiesta_cambi SET eseguito='t' WHERE id_sopralluogo=".$id_sopralluogo." and eseguito is null; ";
	echo $query."<br>";
	//exit;
	$result=pg_query($conn, $query);


	$query="UPDATE segnalazioni.join_sopralluoghi_mobili_squadra SET valido='false' WHERE id_sopralluogo=".$id_sopralluogo." and id_squadra=".$id_squadra_old."; ";
	echo $query."<br>";
	//exit;
	$result=pg_query($conn, $query);

	$query="UPDATE users.t_componenti_squadre SET data_end=now()
	WHERE id_squadra=".$id_squadra_old." AND data_end IS NULL;";
	echo $query."<br>";
	//exit;
	$result=pg_query($conn, $query);
	...
	$query= "INSERT INTO segnalazioni.t_comunicazioni_sopralluoghi_mpbili(id_sopralluogo, testo";
