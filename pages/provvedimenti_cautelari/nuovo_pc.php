...
if($_POST['id_oggetto_rischio']!='') {
	...
	echo "ERRORE: Non � specificato l'ID dell'oggetto a rischio";
	exit;
}
...
$body =  'Hai ricevuto questo messaggio in quanto � stato assegnato un nuovo provvedimento cautelare <br>. Ti preghiamo di non rispondere a questa mail automatica, bens� di visualizzare i dettagli del provvedimento cautelare accedendo 
