...
$query= "UPDATE segnalazioni.t_provvedimenti_cautelari SET note_ente='".$note_rifiuto."', time_stop=now() 
WHERE id=".$id.";";
echo $query."<br>";
//exit;
...
if ($id_lavorazione!=''){
	...
	//values
	$query=$query.") VALUES (".$id_lavorazione.", ' Provvedimento cautelare ".$id." chiuso dalla seguente squadra: ".$uo." con il seguente messaggio: <br><i>".$note_rifiuto." </i><br>- <a class=\"btn btn-info\" href=\"dettagli_provvedimento_cautelare.php?id=".$id."\"> Visualizza dettagli </a>'";
...
$query_log= "INSERT INTO varie.t_log (schema,operatore, operazione) VALUES ('Provvedimenti cautelari','".$operatore ."', 'sopralluogo ".$id." chiuso');";
echo $query_log."<br>";
