...
<div class="collapse" id="collapsedata">
        ...
        <table  id="pres" class="table-hover" data-toggle="table" data-url="./tables/griglia_inc_int.php?r=<?php echo $resp;?>&u=<?php echo $uo;?>&from=<?php echo $filtro_from;?>&to=<?php echo $filtro_to;?>" 
