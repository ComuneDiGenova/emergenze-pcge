...
$subtitle="Elenco incarichi interni chiusi";
...
<div class="collapse" id="collapsedata">
        ...
        <table  id="pres" class="table-hover" data-toggle="table" data-url="./tables/griglia_inc_int_eventi_chiusi.php?r=<?php echo $resp;?>&u=<?php echo $uo;?>&from=<?php echo $filtro_from;?>&to=<?php echo $filtro_to;?>" 
...
<thead>
 	...
 	<tr>
            ...
            <th data-field="id_stato_incarico" data-sortable="false" data-formatter="presidiFormatter" data-visible="true" >Stato</th>
...
function presidiFormatter2(value,row) {
 ...
 function nameFormatterEdit(value) {
		...
		return '<a class="btn btn-warning" target=”_blank” href=./dettagli_incarico_interno.php?id='+value+'> <i class="fas fa-edit"></i> </a>';
